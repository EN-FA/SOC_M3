...
assign  write_enable00 = write_enable & (PADDR[4:2] == 3'h0);
assign  write_enable04 = write_enable & (PADDR[4:2] == 3'h1);
assign  write_enable08 = write_enable & (PADDR[4:2] == 3'h2);
assign  write_enable0c = write_enable & (PADDR[4:2] == 3'h3);
assign  write_enable10 = write_enable & (PADDR[4:2] == 3'h4);
...
// Read operation
 ...
 always @(PADDR or reg_rx_buf or uart_status or reg_ctrl or intr_state or reg_baud_div
  ...
  begin
    ...
    default:  read_mux_byte0 =   {8{1'b0}};// x propogation
    endcase
  end
  ...
  assign read_mux_word[19: 8] = (PADDR[4:2]==3'h4) ? reg_baud_div[19:8] : {12{1'b0}};
...
// Receive
  ...
  assign rx_data_read   = (PSEL & (~PENABLE) & (PADDR[4:2]==3'h0) & (~PWRITE));
